(function(){
  ...
  function insiderBehaviorPanel(d){
    ...
    const rows=h.map(x=>{
      ...
      const currentValueHtml=currentValue==null?'':`<div class="valueLine">${esc(compactKr(currentValue))}</div><div class="valueHint">markedsverdi nå · ${esc(fmt(livePrice,2))} kr</div>`;
