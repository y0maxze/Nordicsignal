  ...
  function render(data){
    ...
    panel.innerHTML=`
      <div class="sectionHead">
        <div><h2>Shadow scan audit</h2><div class="sub">Per-ticker kontroll av siste komplette Opportunity-scan.</div></div>
      ...
      <div class="notice">Siste audited run: <strong>${esc(latest.completed_at||latest.started_at||'ingen ennå')}</strong>. Dette er kun driftsdiagnostikk og påvirker ikke live-score, Opportunity-labels eller terskler.</div>`;
