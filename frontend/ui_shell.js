(function(){
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.id='nsUiShellStyles';s.textContent=`
      ...
      @media(max-width:900px){.nsMobileNav{grid-template-columns:repeat(6,1fr)!important}.nsMobileNav a,.nsMobileNav .nsMobileMoreToggle{font-size:8px!important}.nsAlertShortcut{bottom:96px!important}.top{align-items:center!important}.top>.nsThemeToggle{display:inline-grid!important;place-items:center!important}}
  ...
  function installMobileNav(){
    ...
    nav.innerHTML=`<a href="/mobile"><span class="nsMobileNavIcon">⌂</span>Hjem</a><a href="/morning"><span class="nsMobileNavIcon">☀</span>Før børs</a><a href="/app?view=signals"><span class="nsMobileNavIcon">↗</span>Signaler</a><a href="/holdings"><span class="nsMobileNavIcon">◇</span>Portefølje</a><a href="/stock"><span class="nsMobileNavIcon">⌕</span>Søk</a><button class="nsMobileMoreToggle" type="button"><span class="nsMobileNavIcon">•••</span>Mer</button>`;
