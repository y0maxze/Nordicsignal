...
const SHELL=['/mobile','/capital-flow','/morning','/alerts','/insider','/news','/readiness','/stock','/calendar','/history','/theme.css','/theme_light_fix.css','/theme_mode.js','/brand_config.js','/ui_shell.js','/mobile_nav.js','/history_nav_context.js','/mobile_shell.js','/capital-flow.js','/access_gate.js','/manifest.webmanifest','/insider_clean_ui.js','/portfolio_dashboard.js','/analysis.js','/stock_evidence_ui.js','/event_radar_ui.js','/alerts.js','/alert_local_capture.js','/alert_nav_ui.js'];
